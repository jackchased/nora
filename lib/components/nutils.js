...
nutils.addMic = function (device, data, dir) {
    ...
    if (!_.isString(dir))
        throw new TypeError('dir should be a string.');

    if (dir !== 'uplink' && dir !== 'downlink')
        throw new Error('dir should be uplink or downlink.');
    ...
    // console.log('nora addMic msgBuf');
    // console.log(msgBuf);
