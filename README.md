...
|  Property        |  Type     |  Mandatory  |  Description                                                   |  Default Value  |  
|------------------|-----------|-------------|----------------------------------------------------------------|-----------------|   
|  device          |  Number   |             |  `0`: End-Device, `1`: Server                                  |  1              |  
|  modulation      |  Boolean  |             |  `false`: FSK/OOK, `true`: LoRa                                |  true           |  
|  frequency       |  Number   |             |  Range: `0 ~ 16777215`, Frequency interval(61.035 Hz)          |  0x6c8000       |  
...
|  headerMode      |  Boolean  |             |  `false`: Explicit Header Mode, `true`: Implicit Header Mode   |  0              |  
|  payloadCrc      |  Boolean  |             |  `false`: Disable, `true`: Enable                              |  0              |  
|  preambleLength  |  Number   |             |  Preamble Length. Range: `4 ~ 65539`                           |  8              |  
